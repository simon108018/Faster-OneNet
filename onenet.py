...
class OneNet(object):
    ...
    def generate(self):
        ...
        #   创建onenet模型
        #----------------------------------------#
        self.onenet = onenet(self.input_shape,num_classes=self.num_classes,backbone=self.backbone,mode='predict')
        self.onenet.load_weights(self.model_path, by_name=True)
